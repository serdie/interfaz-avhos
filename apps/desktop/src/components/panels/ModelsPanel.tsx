...
export function ModelsPanel() {
  ...
  return (
    <Panel>
      <PanelHeader title={t('models.title')} />
      <div
        style={{
          padding: '24px 16px',
          display: 'flex',
      ...
      >
        ...
        <div style={{ fontSize: 'var(--font-sm)', color: theme.colors.textMuted, lineHeight: 1.6 }}>
          No hay proveedores de modelos configurados. Para usar el chat IA
          necesitas al menos un proveedor (Ollama, OpenAI, Anthropic, etc.)
          con un modelo disponible y accesible.
        </div>
        <div
          style={{
            padding: '12px',
        ...
        <div style={{ fontSize: 'var(--font-xs)', color: theme.colors.textMuted, fontStyle: 'italic' }}>
          La configuración de proveedores estará disponible cuando se implemente
          la detección automática de modelos locales y remotos.
        </div>
      </div>
    </Panel>
  );
